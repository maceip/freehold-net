...
public:
	...
	virtual void feed_JQv1(__uint128_t& label, const uint64_t& value) = 0;
	...
	virtual __uint128_t mul_gate_JQv1(const __uint128_t& a, const __uint128_t& b) = 0;
	...
	virtual void flush_and_proofs_JQv1() = 0;

	virtual __uint128_t get_one_role() = 0;

	virtual void setup_JQv1(int matrix_sz, int batch_sz) = 0;

	virtual void finalize_inner_product_JQv1(int w_length, int batch_sz) = 0;
};
